...
const FournisseurService = {
    getFournisseurs: () => {
        return Promise.resolve([
            { 
                id: 1, 
                name: 'LABO TECH MAROC', 
                status: 'active', 
                email: 'contact@labotechmaroc.ma', 
                telephone: '0522298745', 
                ville: 'Casablanca', 
                ice: '001548796000123', 
            ...
            { 
                id: 2, 
                name: 'ATLAS LAB SUPPLIES', 
                status: 'active', 
                email: 'info@atlaslabsupplies.com', 
                telephone: '0537721589', 
                ville: 'Rabat', 
                ice: '002365478000456', 
            ...
            { 
                id: 3, 
                name: 'MEDICAL EQUIPMENT MAROC', 
                status: 'active', 
                email: 'sales@medicalequipment.ma', 
                telephone: '0524432156', 
                ville: 'Marrakech', 
                ice: '003214569000789', 
            ...
            { 
                ...
                status: 'active', 
                email: 'commercial@biolab-instruments.ma', 
                telephone: '0535624897', 
                ville: 'Fès', 
                ice: '004587963000147', 
            ...
            { 
                id: 5, 
                name: 'ANALYTICA SERVICES', 
                status: 'bloquer', 
                email: 'direction@analytical-services.ma', 
                telephone: '0523987456', 
                ville: 'Tanger', 
                ice: '005698741000258', 
            ...
            { 
                id: 6, 
                name: 'AGADIR LAB SOLUTIONS', 
                status: 'active', 
                email: 'contact@agadirlabsolutions.com', 
                telephone: '0528456321', 
                ville: 'Agadir', 
                ice: '006325896000369', 
            ...
            { 
                ...
                name: 'LABO EXPRESS', 
                status: 'active', 
                email: 'support@laboexpress.ma', 
                telephone: '0535123648', 
                ville: 'Meknès', 
                ice: '007412536000741', 
            ...
            { 
                ...
                name: 'SCIENCE IMPORT', 
                status: 'bloquer', 
                email: 'import@scienceimport.ma', 
                telephone: '0536895214', 
                ville: 'Oujda', 
                ice: '008523641000852', 
            ...
            { 
                id: 9, 
                name: 'LABO PRO EQUIPEMENT', 
                status: 'active', 
                email: 'ventes@laboproequip.ma', 
            ...
            { 
                id: 10, 
                name: 'DIAGNOSTIC TOOLS MAROC', 
                status: 'bloquer', 
                email: 'admin@diagnostictools.ma', 
                telephone: '0525789632', 
                ville: 'El Jadida', 
                ice: '010147258000159', 
...
function List() {
    ...
    const actionBodyTemplate = (rowData) => (
        <>
            <Button icon="pi pi-pencil" rounded text severity="success" className="mr-2" onClick={() => router.push(`/fournisseurs/edit`)} />
    ...
    const deleteUser = () => {
        FournisseurService.deleteUser(userToDelete.id)
            .then(() => {
            ...
            <div className="flex flex-wrap gap-2 align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <Button 
                        ...
                        onClick={() => router.push('/fournisseurs/create')} 
                        tooltip="Ajouter" 
                        tooltipOptions={{ position: 'top' }} 
                    />
    ...
    return (
        <div className="card">
            <Toast ref={toast} />
            <span className="text-900 text-xl font-bold mb-4 block text-blue-700"><i className="pi pi-users" /> &nbsp;&nbsp;Liste des fournisseurs</span>
            ...
            <Dialog visible={deleteUserDialog} style={{ width: '450px' }} header="Confirmer la suppression" modal footer={deleteUserDialogFooter} onHide={() => setDeleteUserDialog(false)}>
                <div className="flex align-items-center justify-content-center">
                    ...
                    {userToDelete && (
                        <span>Confirmez-vous la suppression de ce fournisseur?</span>
                    )}
                </div>
            </Dialog>
        </div>
