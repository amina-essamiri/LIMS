    ...
    return (
        <div className="card">
                    ...
                    <span className="text-900 text-xl font-bold mb-4 block text-blue-700 mb-5">
                        <i className="pi pi-user" />&nbsp;&nbsp;Modifier un sous-traitant
                    </span>
                            ...
                            <div className="border-1 surface-border border-round p-fluid mb-4">
                                ...
                                <div className="p-3">
                                    ...
                                    <span className="p-input-icon-left">
                                        ...
                                        <InputText type="text" placeholder="Adresse sous-traitant" />
                                    </span>
                                    <br />
                                ...
                                <div className="p-3">
                                    ...
                                    <div className="mb-4 ">
                                        <span className="p-input-icon-left">
                                            ...
                                            <InputText type="text" placeholder="Remise sous-traitant" />
                                        </span>
                                    </div>
                                    <div className="mb-4 ">
                                        <span className="p-input-icon-left">
