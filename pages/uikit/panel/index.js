...
const PanelDemo = () => {
    ...
    const createFunction = async () => {
        const todoDetails = {
            name: 'fatty',
            id : 1,
            description: 'fatty is a good girl'
          };
         const typeTodo = await client.graphql({
    ...
    const updateFunction = async () => {
        const todoDetails = {
            name: 'fatty',
            id : 1,
            description: 'fatty is a bad girl'
          };
         const howTodo = await client.graphql({
              ...
              listTodos: {
                items: [
                  ...
                  },
                  {
                    ...
                    description: "Visit ' island of princess '",
                    status: "IN_PROGRESS"
                  },
                  {
                    id: "5",
                ...
                nextToken: null // or some token if there are more items to fetch
              }
            }
          };
    ...
    const toolbarLeftTemplate = () => {
        return (
            <>
                <Button label="New" icon="pi pi-plus" style={{ marginRight: '.5em' }}  onClick={updateFunction}/>
                <Button label="Open" icon="pi pi-folder-open" className="p-button-secondary" onClick={createFunction} />

                <i className="pi pi-bars p-toolbar-separator" style={{ marginRight: '.5em' }}></i>

                <Button icon="pi pi-check" className="p-button-success" style={{ marginRight: '.5em' }} onClick={deleteFunction} />
                <Button icon="pi pi-trash" className="p-button-warning" style={{ marginRight: '.5em' }} onClick={listtodosFunction}/>
                <Button icon="pi pi-print" className="p-button-danger"onClick={getFunction} />
            </>
        );
    };
