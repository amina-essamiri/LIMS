    ...
    return (
        <div className="card">
            <span className="block text-900 text-xl font-bold mb-4 text-blue-700">
                <i className="pi pi-user" />&nbsp;&nbsp;Créer un profil
            </span>
            ...
            {/* <div className='col-12' style={{marginLeft: '1566px'}}>
                <Button className="p-button-danger flex-1 p-button-outlined mr-3 p-3" label="Annuler" icon="pi pi-fw pi-times" ></Button>
                <Button className="p-button-primary flex-1 mr-3 p-3" label="Modifier" icon="pi pi-fw pi-check"></Button>
            </div> */}
