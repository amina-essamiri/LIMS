...
const [selectedFamilleParamètre, setSelectedFamilleParamètre] = useState([]);
    ...
    description: 'ARRETE CONJOINT DU MINISTRE DE L’EQUIPEMENT ET DU MINISTRE CHARGE DE AMENAGEMENT DU TERRITOIRE.',
    statutActivation: true
};
    ...
    return (
        <div className="card">
            ...
            <span className="block text-900 text-xl font-bold mb-4 text-blue-700">
                <i className="pi pi-stop" />&nbsp;&nbsp;Modifier la réglementation
            </span>
                            ...
                            <div className="flex justify-content-between">
                                <div className="col-6">
                                    <div className="border-1 surface-border border-round p-fluid mb-4">
                                        <span className="text-900 font-bold block border-bottom-1 surface-border p-3">Modifier la réglementation </span>
                                        <div className="p-3">
                                            {/* Nom */}
                                            <div className="mb-4">
                                                <InputText
                                                    id="nom"
                                                    value={nom}
                                                    placeholder='Nom de la réglementation *'
                                ...
                                <div className="col-6">
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '50px' }}>
                                        <Button
                                            ...
                                            onClick={() => { router.push(`/analytics/reglementations`); }}
                                                ...
                                                if (validateForm()) {
                                                    ...
                                                    if (toast.current) {
                                                        toast.current.show({
                                                            severity: 'success',
                                                            summary: 'Succès',
                                                            detail: 'réglementation enregistrée avec succès.',
                                                            life: 4000
                                                        });
                                                    }
                                                } else {
