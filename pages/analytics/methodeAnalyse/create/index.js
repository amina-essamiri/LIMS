    ...
    return (
        <div className="card">
            ...
            <span className="block text-900 text-xl font-bold mb-4 text-blue-700">
                <i className="pi pi-stop" />&nbsp;&nbsp;Créer une nouvelle méthode d&apos;analyse
            </span>
                            ...
                            <div className="flex justify-content-between">
                                <div className="col-6">
                                    <div className="border-1 surface-border border-round p-fluid mb-4">
                                        <span className="text-900 font-bold block border-bottom-1 surface-border p-3">Créer la méthode d&apos;analyse </span>
                                        <div className="p-3">
                                            {/* Nom */}
                                            <div className="mb-4">
                                                <InputText
